...
resource "aws_elastic_beanstalk_application" "tftest" {
  ...
  description = "tftest Elastic Beanstalk Application"
}
...
resource "aws_elastic_beanstalk_environment" "tf-test-name" {
  ...
  platform_arn = "64bit Amazon Linux 2 v3.5.5 running PHP 8.1"  # Set the desired solution stack for PHP 8.1
  ...
  tags = {
    Name = "prod"  # Set your desired tags
  }
}
